CREATE OR REPLACE PROCEDURE ETL_IDW.SP_CD_RES_SMR_B2B_BBR_2 (
...
BEGIN
  ...
  /* 1.프 로 젝 트 : ARES                                                                         */
  /* 2.모       듈 :                                                                              */
  /* 3.프로그램 ID : SP_CD_RES_SMR_B2B_BBR_2                                                   */
  ...
  /************************************************************************************************/
    DECLARE v_etl_job_no                 VARCHAR(40)   DEFAULT 'SP_CD_RES_SMR_B2B_BBR_2';
