...
/***************************************************************************************************/
 ...
 IS
    ...
    PROCEDURE sp_rs_kpi_prod_bep(iv_yyyymm     IN VARCHAR2
                                ,iv_category   IN VARCHAR2);
...
/* 3.프로그램 ID : pg_rs_kpi_smart
/* 4.기       능 : ARES SMART 적재
/*                 1. sp_rs_kpi_prod_bep - 제품별 한계적자금액 ['BEP_SMART_PROD_BEP']
/* 5.입 력 변 수 :
/*                 [필수] iv_yyyymm( 기준월 )
/*                 [필수] iv_category( 시산구분 )
/* 6.Source      :
...
/***************************************************************************************************/
    PROCEDURE sp_rs_kpi_prod_bep(iv_yyyymm     IN VARCHAR2
                                 ,iv_category   IN VARCHAR2)
    IS
        vv_act_name  VARCHAR2(1000) := 'sp_rs_kpi_prod_bep (' || iv_yyyymm || ')';
        vn_row_cnt   NUMBER;
    ...
    BEGIN
        ...
        BEGIN
           ...
           SELECT '1700'                AS prcs_seq                                 
                 ...
                 ,'BEP_SMART'           AS rs_clsf_id                               
                 ,iv_category           AS rs_type_cd                               
                 ,'BEP_SMART_PROD_BEP'  AS rs_type_name                             
