...
/* 4.기       능 : ARES SMART 적재
/*                 1. sp_rs_kpi_bb_ratio_th - BB RATIO(TV사이니지/HOTEL TV)적재 ['BEP_SMART_BB']
/* 5.입 력 변 수 :
/*                 [필수] iv_yyyymm( 기준월 )
/*                 [필수] iv_category( 시산구분 )
/* 6.Source      :
...
/* 3.프로그램 ID : pg_rs_kpi_smart
/* 4.기       능 : ARES SMART 적재
/*                 1. sp_rs_kpi_cnt_sale - CNT 제품별적재 ['BEP_SMART_CNT']
/* 5.입 력 변 수 :
/*                 [필수] iv_yyyymm( 기준월 )
/*                 [필수] iv_category( 시산구분 )
/* 6.Source      :
...
/***************************************************************************************************/
    PROCEDURE sp_rs_kpi_cnt_sale(iv_yyyymm     IN VARCHAR2
                                ,iv_category   IN VARCHAR2)
    IS
        vv_act_name  VARCHAR2(1000) := 'sp_rs_kpi_cnt_sale (' || iv_yyyymm || ')';
        vn_row_cnt   NUMBER;
